...
Patch-Nops $bytes 0x00421B7E $rankingDeleteBlock "CScenRanking scalar-delete operator delete"
...
Patch-Nops $bytes 0x00421BB5 $rankingFormCleanupBlock "CScenRanking destructor form cleanup"
